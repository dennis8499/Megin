...
description: Search and review target-project knowledge for a Megin v3 delivery with source provenance, conflict checks, and explicit promotion boundaries.
---
...
For v3, the approved `knowledge_scope` is the only promotion boundary. After implementation and
